    ...
    <div className="bg-gradient-to-br from-blue-50 to-green-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
          ...
          <div className="lg:w-1/2">
            <div className="bg-white p-8 rounded-xl shadow-md border border-blue-100">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Welcome to Neurica</h2>
              <div className="space-y-6 text-gray-600">
                <p>Welcome to Neurica, your trusted partner in managing your healthcare needs conveniently and efficiently. At Neurica, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.</p>
                
                <p>Neurica is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, Neurica is here to support you every step of the way.</p>
                
                <div>
                  <h3 className="text-xl font-semibold text-green-600 mb-3">Our Vision</h3>
                  <p>Our vision at Neurica is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-500">Discover what makes Neurica different</p>
        </div>
